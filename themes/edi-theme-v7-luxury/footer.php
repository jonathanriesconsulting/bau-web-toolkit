    ...
    <div class="footer__top">
      <div class="footer__brand">
        <a href="#top" class="brand">
          ...
          <span class="brand__text"><span class="brand__name" style="color:var(--c-text)">EDI Hochbau GmbH</span><span class="brand__tagline">Rohbau · Berlin · Brandenburg</span></span>
        </a>
        <p>Stahlbeton- und Massivbau-Subunternehmer für Generalunternehmer. PQ-VOB präqualifiziert, VOB/B-konform, eigene Kolonnen und Geräte.</p>
      </div>
      <div class="footer__col">
        <h4>Leistungen</h4>
        <ul><li><a href="#leistungen">Stahlbeton & Sichtbeton</a></li><li><a href="#leistungen">Mauerwerksbau</a></li><li><a href="#leistungen">Schalungsarbeiten</a></li><li><a href="#leistungen">Bewehrungsarbeiten</a></li><li><a href="#leistungen">Schlüsselfertiger Rohbau</a></li></ul>
      </div>
      <div class="footer__col">
        <h4>Compliance</h4>
