...
define( 'PKB_THEME_VERSION', '1.5.6' );
...
add_action( 'wp_head', static function () {
	...
	$img   = $theme . '/assets/images/hero-quartier-berlin.jpg';
	...
	echo '<meta property="og:image:alt" content="Wohnquartier-Baustelle mit Baukran in Berlin — Generalunternehmer für Mehrfamilienhäuser">' . "\n";
